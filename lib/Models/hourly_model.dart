...
HourlyModel hourlyModelFromJson(String str) => HourlyModel.fromJson(json.decode(str));

String hourlyModelToJson(HourlyModel data) => json.encode(data.toJson());
...
//         id: json["id"],
//         main: mainEnumValues.map[json["main"].toString()]!,
...
//     Map<String, dynamic> toJson() => {
//         "id": id,
//         "main": mainEnumValues.reverse[main].toString(),
